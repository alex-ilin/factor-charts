...
USING: accessors arrays charts charts.axes charts.lines
colors.constants kernel literals locals math math.constants
math.functions sequences ui ui.gadgets ;
IN: charts.demos
